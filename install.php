  ...
  && isset($_POST['dbpass'])){
    ...
    && isset($_POST['admin_password']) && strlen($_POST['admin_password']) > 0){
      ...
      if(isset($_POST['logo']) && strlen($_POST['logo']) > 0){
        ...
        $db->query("CREATE TABLE `funnyweb`.`funnyweb_payments` ( `id` INT(11) NOT NULL AUTO_INCREMENT , `name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_polish_ci NOT NULL , `description` TEXT CHARACTER SET utf8 COLLATE utf8_polish_ci NOT NULL , `number` INT(8) NOT NULL , `content_sms` VARCHAR(32) NOT NULL , `commands` VARCHAR(512) CHARACTER SET utf8 COLLATE utf8_polish_ci NOT NULL, `image` VARCHAR(512) NOT NULL, `service_id` INT(11) NOT NULL, PRIMARY KEY (`id`)) ENGINE = InnoDB;");
