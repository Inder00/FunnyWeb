		...
		<div class="container mb50">
			...
			<div class="row mb30 no-margin">
				<div class="col-sm-5 text-center">
					<h3><span>TOP 50 GRACZY</span></h3>
				</div>
				<div class="col-sm-2"></div>
				<div class="col-sm-5 text-center float-md-right">
					<h3><span>TOP 50 GILDII</span></h3>
				</div>
				<hr>
				<div class="col-sm-5 tabelka black-text">
					<?php
					$sql = "SELECT * FROM users ORDER BY points DESC LIMIT 50";
					...
					<div class="text-center">
						<a href="<?php echo $core->webUrl; ?>" class="btn btn-outline-primary mb5"><span>-</span> Pokaż mniej</a>
					</div>
				</div>
				<div class="col-sm-2">
				</div>
				<div class="col-sm-5 tabelka black-text">
					<?php
					$sql = "SELECT * FROM guilds ORDER BY points DESC LIMIT 50";
					$stmt = $core->db->prepare($sql);
					$stmt->execute();
