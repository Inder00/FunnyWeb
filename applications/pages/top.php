...
<html lang="pl">
    ...
    <body>
        ...
        <div class="page-custom-header title-space-lg bg-parallax mb80" data-jarallax='{"speed": 0.2}' style='background-image: url("<?php echo $core->background; ?>");background-position:top center;'>
            <div class="container">
                <div class="row">
                    <div class=" col-md-12">
				...
				<iframe src="https://www.topkamc.pl/widget/banner/ID-SERWERA?background_color=0072f0&font_color=" width="350" height="80" allowtransparency="true" frameborder="0"></iframe>
            </div>
        </div>
